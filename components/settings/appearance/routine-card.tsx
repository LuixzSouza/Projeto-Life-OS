...
export function RoutineCard({ workStart, setWorkStart, workEnd, setWorkEnd, language, setLanguage }: RoutineCardProps) {
  return (
    <Card className="border-border shadow-sm bg-card">
      <CardHeader>
        ...
        <CardDescription>Horário de trabalho (usado na Agenda) e idioma do sistema.</CardDescription>
      </CardHeader>
