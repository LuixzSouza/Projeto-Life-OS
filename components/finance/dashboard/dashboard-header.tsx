...
export function DashboardHeader({ accounts }: DashboardHeaderProps) {
  return (
    <header className="sticky top-0 z-30 border-b border-border/40 bg-background/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-col xl:flex-row justify-between items-start xl:items-center gap-6 px-6 py-5 sm:px-8">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">Visão consolidada do seu patrimônio e fluxo de caixa.</p>
          </div>
        </div>
