...
INSERT INTO "new_RecurringCharge" ("active", "amount", "billingId", "category", "clientId", "clientName", "createdAt", "dayOfMonth", "id", "title", "updatedAt", "userId") SELECT "active", "amount", "billingId", "category", "clientId", "clientName", "createdAt", "dayOfMonth", "id", "title", "updatedAt", "userId" FROM "RecurringCharge";
...
INSERT INTO "new_RecurringExpense" ("active", "amount", "category", "categoryId", "createdAt", "dayOfMonth", "id", "title", "userId") SELECT "active", "amount", "category", "categoryId", "createdAt", "dayOfMonth", "id", "title", "userId" FROM "RecurringExpense";
