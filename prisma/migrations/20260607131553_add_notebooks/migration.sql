...
INSERT INTO "new_StudyNote" ("content", "contentId", "createdAt", "deletedAt", "id", "isFavorite", "lastReviewed", "reviewCount", "sessionId", "subjectId", "summary", "tags", "title", "updatedAt", "userId") SELECT "content", "contentId", "createdAt", "deletedAt", "id", "isFavorite", "lastReviewed", "reviewCount", "sessionId", "subjectId", "summary", "tags", "title", "updatedAt", "userId" FROM "StudyNote";
