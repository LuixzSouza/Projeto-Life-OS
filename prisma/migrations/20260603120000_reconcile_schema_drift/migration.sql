-- AlterTable
ALTER TABLE "WardrobeItem" ADD COLUMN "deletedAt" DATETIME;
...
INSERT INTO "new_AccessItem" ("category", "client_name", "createdAt", "id", "notes", "password", "title", "updatedAt", "url", "userId", "username") SELECT "category", "client_name", "createdAt", "id", "notes", "password", "title", "updatedAt", "url", "userId", "username" FROM "AccessItem";
DROP TABLE "AccessItem";
ALTER TABLE "new_AccessItem" RENAME TO "AccessItem";
...
INSERT INTO "new_Account" ("balance", "color", "createdAt", "externalId", "id", "isConnected", "name", "provider", "type", "updatedAt", "userId") SELECT "balance", "color", "createdAt", "externalId", "id", "isConnected", "name", "provider", "type", "updatedAt", "userId" FROM "Account";
DROP TABLE "Account";
...
INSERT INTO "new_AiChat" ("createdAt", "id", "title") SELECT "createdAt", "id", "title" FROM "AiChat";
DROP TABLE "AiChat";
...
INSERT INTO "new_AiMessage" ("chatId", "content", "createdAt", "id", "model", "provider", "role") SELECT "chatId", "content", "createdAt", "id", "model", "provider", "role" FROM "AiMessage";
...
INSERT INTO "new_Billing" ("billingDay", "clientId", "createdAt", "description", "id", "installments", "startDate", "status", "title", "totalValue", "type", "updatedAt") SELECT "billingDay", "clientId", "createdAt", "description", "id", "installments", "startDate", "status", "title", "totalValue", "type", "updatedAt" FROM "Billing";
DROP TABLE "Billing";
...
INSERT INTO "new_Client" ("address", "company", "createdAt", "document", "email", "id", "name", "notes", "phone", "status", "updatedAt", "userId") SELECT "address", "company", "createdAt", "document", "email", "id", "name", "notes", "phone", "status", "updatedAt", "userId" FROM "Client";
DROP TABLE "Client";
...
INSERT INTO "new_Flashcard" ("box", "createdAt", "deckId", "definition", "easeFactor", "id", "imageUrl", "interval", "lastReviewed", "nextReview", "reviewCount", "term") SELECT "box", "createdAt", "deckId", "definition", "easeFactor", "id", "imageUrl", "interval", "lastReviewed", "nextReview", "reviewCount", "term" FROM "Flashcard";
...
INSERT INTO "new_FlashcardDeck" ("algorithm", "createdAt", "description", "id", "isPublic", "masteredCount", "shareCode", "studySubjectId", "title", "updatedAt") SELECT "algorithm", "createdAt", "description", "id", "isPublic", "masteredCount", "shareCode", "studySubjectId", "title", "updatedAt" FROM "FlashcardDeck";
...
INSERT INTO "new_Friend" ("address", "birthday", "company", "createdAt", "email", "giftIdeas", "id", "imageUrl", "instagram", "jobTitle", "linkedin", "name", "nickname", "notes", "phone", "pixKey", "proximity", "twitter", "updatedAt", "userId") SELECT "address", "birthday", "company", "createdAt", "email", "giftIdeas", "id", "imageUrl", "instagram", "jobTitle", "linkedin", "name", "nickname", "notes", "phone", "pixKey", "proximity", "twitter", "updatedAt", "userId" FROM "Friend";
DROP TABLE "Friend";
...
INSERT INTO "new_HealthMetric" ("date", "id", "type", "value") SELECT "date", "id", "type", "value" FROM "HealthMetric";
...
INSERT INTO "new_Invoice" ("billingId", "createdAt", "dueDate", "id", "linkUrl", "paidAt", "status", "title", "updatedAt", "value") SELECT "billingId", "createdAt", "dueDate", "id", "linkUrl", "paidAt", "status", "title", "updatedAt", "value" FROM "Invoice";
DROP TABLE "Invoice";
...
INSERT INTO "new_JobApplication" ("appliedDate", "company", "id", "jobUrl", "location", "requirements", "role", "salary", "status", "type", "updatedAt", "userId") SELECT "appliedDate", "company", "id", "jobUrl", "location", "requirements", "role", "salary", "status", "type", "updatedAt", "userId" FROM "JobApplication";
...
INSERT INTO "new_LearningGoal" ("createdAt", "description", "id", "priority", "status", "subjectId", "targetDate", "title", "updatedAt") SELECT "createdAt", "description", "id", "priority", "status", "subjectId", "targetDate", "title", "updatedAt" FROM "LearningGoal";
...
INSERT INTO "new_LearningTask" ("createdAt", "goalId", "id", "isDone", "orderIndex", "title") SELECT "createdAt", "goalId", "id", "isDone", "orderIndex", "title" FROM "LearningTask";
...
INSERT INTO "new_ManagedSite" ("apiKey", "createdAt", "id", "name", "url") SELECT "apiKey", "createdAt", "id", "name", "url" FROM "ManagedSite";
DROP TABLE "ManagedSite";
ALTER TABLE "new_ManagedSite" RENAME TO "ManagedSite";
...
INSERT INTO "new_Meal" ("calories", "date", "id", "items", "title", "type") SELECT "calories", "date", "id", "items", "title", "type" FROM "Meal";
DROP TABLE "Meal";
...
INSERT INTO "new_MealPlan" ("calories", "createdAt", "dayOfWeek", "id", "isCompleted", "items", "mealType", "title", "updatedAt", "userId") SELECT "calories", "createdAt", "dayOfWeek", "id", "isCompleted", "items", "mealType", "title", "updatedAt", "userId" FROM "MealPlan";
DROP TABLE "MealPlan";
...
INSERT INTO "new_MediaItem" ("category", "coverUrl", "createdAt", "externalId", "id", "rating", "subtitle", "title", "type", "updatedAt") SELECT "category", "coverUrl", "createdAt", "externalId", "id", "rating", "subtitle", "title", "type", "updatedAt" FROM "MediaItem";
...
INSERT INTO "new_Project" ("clientId", "color", "createdAt", "description", "id", "slug", "status", "title", "userId") SELECT "clientId", "color", "createdAt", "description", "id", "slug", "status", "title", "userId" FROM "Project";
DROP TABLE "Project";
...
INSERT INTO "new_RecurringExpense" ("active", "amount", "category", "createdAt", "dayOfMonth", "id", "title") SELECT "active", "amount", "category", "createdAt", "dayOfMonth", "id", "title" FROM "RecurringExpense";
...
INSERT INTO "new_RoutineItem" ("category", "createdAt", "daysOfWeek", "description", "endTime", "id", "startTime", "title") SELECT "category", "createdAt", "daysOfWeek", "description", "endTime", "id", "startTime", "title" FROM "RoutineItem";
DROP TABLE "RoutineItem";
ALTER TABLE "new_RoutineItem" RENAME TO "RoutineItem";
CREATE INDEX "RoutineItem_userId_idx" ON "RoutineItem"("userId");
CREATE TABLE "new_SavedLink" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "title" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    "description" TEXT,
...
INSERT INTO "new_SavedLink" ("category", "createdAt", "description", "id", "imageUrl", "isFavorite", "title", "updatedAt", "url") SELECT "category", "createdAt", "description", "id", "imageUrl", "isFavorite", "title", "updatedAt", "url" FROM "SavedLink";
DROP TABLE "SavedLink";
ALTER TABLE "new_SavedLink" RENAME TO "SavedLink";
...
INSERT INTO "new_Settings" ("accentColor", "aiModel", "aiPersona", "aiProvider", "aiUsage", "currency", "googleKey", "groqKey", "id", "language", "onboardingCompleted", "openaiKey", "storagePath", "theme", "updatedAt", "userId", "workEnd", "workStart") SELECT "accentColor", "aiModel", "aiPersona", "aiProvider", "aiUsage", "currency", "googleKey", "groqKey", "id", "language", "onboardingCompleted", "openaiKey", "storagePath", "theme", "updatedAt", "userId", "workEnd", "workStart" FROM "Settings";
DROP TABLE "Settings";
...
INSERT INTO "new_SitePage" ("content", "id", "siteId", "slug", "updatedAt") SELECT "content", "id", "siteId", "slug", "updatedAt" FROM "SitePage";
DROP TABLE "SitePage";
...
INSERT INTO "new_StudyContent" ("author", "createdAt", "duration", "id", "isCompleted", "progress", "source", "subjectId", "title", "typeId", "updatedAt", "url") SELECT "author", "createdAt", "duration", "id", "isCompleted", "progress", "source", "subjectId", "title", "typeId", "updatedAt", "url" FROM "StudyContent";
...
INSERT INTO "new_StudyNote" ("content", "contentId", "createdAt", "id", "isFavorite", "lastReviewed", "reviewCount", "sessionId", "subjectId", "summary", "tags", "title", "updatedAt") SELECT "content", "contentId", "createdAt", "id", "isFavorite", "lastReviewed", "reviewCount", "sessionId", "subjectId", "summary", "tags", "title", "updatedAt" FROM "StudyNote";
...
INSERT INTO "new_StudySession" ("date", "durationMinutes", "focusLevel", "id", "notesRaw", "subjectId") SELECT "date", "durationMinutes", "focusLevel", "id", "notesRaw", "subjectId" FROM "StudySession";
...
INSERT INTO "new_StudySubject" ("category", "color", "createdAt", "description", "difficulty", "goalMinutes", "icon", "id", "parentId", "status", "title", "updatedAt") SELECT "category", "color", "createdAt", "description", "difficulty", "goalMinutes", "icon", "id", "parentId", "status", "title", "updatedAt" FROM "StudySubject";
DROP TABLE "StudySubject";
ALTER TABLE "new_StudySubject" RENAME TO "StudySubject";
...
INSERT INTO "new_Transaction" ("accountId", "amount", "category", "createdAt", "date", "description", "id", "type") SELECT "accountId", "amount", "category", "createdAt", "date", "description", "id", "type" FROM "Transaction";
...
INSERT INTO "new_UserStats" ("badges", "currentStreak", "dailyGoalMinutes", "id", "lastStudyDate", "updatedAt", "userId") SELECT "badges", "currentStreak", "dailyGoalMinutes", "id", "lastStudyDate", "updatedAt", "userId" FROM "UserStats";
...
INSERT INTO "new_WishlistItem" ("createdAt", "id", "imageUrl", "name", "price", "priority", "productUrl", "saved", "status") SELECT "createdAt", "id", "imageUrl", "name", "price", "priority", "productUrl", "saved", "status" FROM "WishlistItem";
...
INSERT INTO "new_Workout" ("date", "distance", "duration", "exercises", "feeling", "id", "intensity", "muscleGroup", "notes", "pace", "title", "type") SELECT "date", "distance", "duration", "exercises", "feeling", "id", "intensity", "muscleGroup", "notes", "pace", "title", "type" FROM "Workout";
DROP TABLE "Workout";
