...
INSERT INTO "new_RecurringCharge" ("active", "amount", "billingId", "category", "clientId", "clientName", "createdAt", "dayOfMonth", "endDate", "frequency", "id", "startDate", "title", "updatedAt", "userId") SELECT "active", "amount", "billingId", "category", "clientId", "clientName", "createdAt", "dayOfMonth", "endDate", "frequency", "id", "startDate", "title", "updatedAt", "userId" FROM "RecurringCharge";
