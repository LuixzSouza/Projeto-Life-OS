...
CREATE TABLE `Settings` (
    ...
    `anthropicKey` VARCHAR(191) NULL,
    `xaiKey` VARCHAR(191) NULL,
    ...
    `brapiToken` VARCHAR(191) NULL,
    `marketWatchlist` VARCHAR(191) NULL,
...
CREATE TABLE `EntityLink` (
    ...
    `kind` VARCHAR(191) NOT NULL DEFAULT 'RELATED',
    `userId` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
